  ...
  return (    
      <nav className="navbar navbar-expand-lg my-navbar bg-primary">        
          <Link className="my-logo" to="/">
            <img src="https://firebasestorage.googleapis.com/v0/b/net-react-rdx-fireb.appspot.com/o/ts-logo.png?alt=media&token=cfdb584c-fced-43c4-aaef-b4c92f5d180f" alt="" className="my-logo-img"/>
          </Link>
          <button
